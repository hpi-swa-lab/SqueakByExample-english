...
Beside \ct{SystemNavigation}, there are also several subclasses of \clsind{Categorizer} that manage the categories in which classes or methods are organized.
Concretely, a \clsind{ClassOrganizer} records the organization of methods in a class, and analogously, a \clsind{SystemOrganizer} records the organization of classes within system categories.
For example, you can retrieve all classes that are in the system category \ct{Collections-Strings} by sending \mthind{SystemOrganizer}{allClassesIn:} to the default \ct{SystemOrganizer} instance:
\begin{code}{@TEST}
