...
%%{SBESqueakPicture writeTo: './figures/MC+SBE.png' frame: #morphs using: [:helper |
%%	| packageFilter packageList |
%%	thisContext wrap: [:block | helper mcIgnoreAllModificationsBut: #('SBE') during: [
%%		block value.
%%		helper takeScreenshot]].
%%	MCWorkingCopyBrowser open.
...
%%{SBESqueakPicture writeTo: './figures/SBE-apb.png' frame: #morphs using: [:helper |
%%	| packageFilter packageList repositoryFilter repositoryList |
%%	thisContext wrap: [:block | helper mcIgnoreAllModificationsBut: #('SBE') during: [
%%		block value.
%%		helper assureScreenshot]].
%%	MCWorkingCopyBrowser open.
%%	packageFilter := '(\* )?SBE \(\)' asRegex.
%%	packageList := helper listMorphIncludingMatch: packageFilter in: helper foregroundWindow.
%%	helper select: packageList at: packageFilter andScrollIntoViewBy: 5.
...
%%			helper type: 'Initial commit for the SBE package' into: messageField.
