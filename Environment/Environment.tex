...
.
	...
	recorder writeTo: 'debuggerDetect.png' building: [:helper |
		...
		helper click: (helper buttonLabeled: 'Debug.*' asRegex in: helper foregroundWindow).
		helper scaleDefaultDebugger: helper foregroundWindow.
		targetContext := '.*detect\:ifFound\:ifNone\:' asRegex.
	...
	recorder writeTo: 'RestartDetect.png' building: [:helper |
		helper click: (helper buttonLabeled: 'Restart.*' asRegex in: helper foregroundWindow).
	].
	recorder writeTo: 'steppingIntoValue.png' building: [:helper |
		| stepThrough contextVarList debugger |
		stepThrough := helper buttonLabeled: 'Through.*' asRegex in: helper foregroundWindow.
	...
	recorder writeTo: 'dotIsAString.png' building: [:helper |
		helper click: (helper buttonLabeled: 'Into.*' asRegex in: helper foregroundWindow).
	].
]
\end{ExecuteSmalltalkScript}
\begin{figure}[btp]
