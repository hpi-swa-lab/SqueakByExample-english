...
First, you can send the message \mthind{BlockClosure}{timeToRun} to a block to measure the time it takes to execute it:
...
Note that the message tally is a sampling profiler, so for detailed information, you will have to let your code run for some seconds (e.g. by running it 1000 times if it only takes a little time).
