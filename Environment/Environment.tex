...
%%{SBESqueakPicture writeTo: './figures/SystemBrowser0.png' frame: #morphs using: [
%%	Browser open
%%]}
\begin{figure}[htbp]
   \centering
...
%%{SBESqueakPicture writeTo: './figures/SystemBrowser1.png' frame: #morphs using: [
...
%%{SBESqueakPicture writeTo: './figures/SystemBrowserMyDependents.png' frame: #morphs using: [
...
%%{SBESqueakPicture writeTo: './figures/SystemBrowserClassCreation.png' frame: #morphs using: [
