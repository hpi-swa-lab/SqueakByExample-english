...
\hint{What if you delete a method entirely, and then decide that you want it back?
	...
	The change set browser is described in \secref{vc:changeSet}.
...
packages.
To browse all classes of a Monticello package, you can open a Snapshot Browser from the Monticello Browser (see \secref{MonticelloVCS}) by selecting a package and then pressing \button{Browse}.
