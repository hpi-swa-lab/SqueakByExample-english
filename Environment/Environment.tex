...
%%	helper scaleDefaultBrowser: helper foregroundWindow.
%%	helper mouseEnter: (helper codePaneOfBrowser: helper foregroundWindow).
%%]}
\begin{figure}[htbp]
   \centering
   \ifluluelse
...
SBEScreenshotRecorder writeInto: './figures' recordSeries: [:picture :helper |
	...
	picture writeTo: 'SBE-apb.png' frame: #morphs building: [
		| repositoryFilter repositoryList relevantOperations |
		...
		[(MCWorkingCopy forPackageNamed: 'SBE-Monticello') in: [:workingCopy |
			relevantOperations := (workingCopy package snapshot patchRelativeToBase: workingCopy parentSnapshot) operations].
		...
		helper
			...
			then: [| messageField |
				...
				messageField setText: 'Change a few things'; flag: #workaround.
	...
	picture writeTo: 'package-cache-browser.png' building: [
		...
		window model versionSelection: 1."
		helper scaleWindow: helper foregroundWindow extent: 600 @ "350"1000.
...
SBEScreenshotRecorder writeTo: './figures/MCaddToPackage.png' building: [:helper |
	...
	helper mouseEnter: repositoryList.
