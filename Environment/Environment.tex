...
There are many special variants of the inspector for different kinds of collections, methods, \SqVersionSwitch{6.0}{morphs,}{} and a few other classes that make it easier to examine the contents of these special objects.
\SqVersionSwitch{6.0}{
For instance, if you \menu{inspect it} an \ct{EllipseMorph} by doing \ct{EllipseMorph new openInWorld; inspect}, you will see a window like that shown in \figref{inspectMorph} that has special fields for accessing the geometry, the screenshot, and the properties of the button.
...
For instance, you can \menu{inspect} the value of the field, \menu{browse} its class, or search all \menu{references} or \menu{assignments} to the selected variable.
...
As you drag the ellipse around, you will see the position of the ellipse change in the inspector.
}{}
