...
SBEScreenshotRecorder debugging writeInto: './figures' recordSeries: [:recorder |
	recorder writeTo: 'fileList.png' building: [:helper |
		| csName csPattern fileList |
		...
		FileList open.
		csPattern := '*{1}*.cs' format: {csName}.
		fileList := helper listMorphIncludingMatch: csPattern in: helper foregroundWindow.
		helper select: fileList at: csPattern].
