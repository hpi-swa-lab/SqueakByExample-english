...
"SBE Monticello series"
SBEScreenshotRecorder recordSeries: [:picture :helper |
	thisContext wrap: [:block | helper mcIgnoreAllModificationsBut: #('SBE') during: block].
	
	MCWorkingCopyBrowser open.
	picture writeTo: './figures/MC+SBE.png' frame: #morphs building: [
	...
	picture writeTo: './figures/SBE-apb.png' frame: #morphs building: [
