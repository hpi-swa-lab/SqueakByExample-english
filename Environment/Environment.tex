...
.
	...
	thisContext wrap: [:block | helper restoreMethods: (allTests collect: [:test | StringTest >> test]) after: block].
	(allTests copyWithout: #testSuffixFound) do: [:test | StringTest removeSelector: test].
