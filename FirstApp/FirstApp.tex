...
\dothis{Load the latest version of the \ct{SBE-Quinto} repository.}

You can also use the \button{Save} button to save another version of your package to the repository.
This requires you to have write access to the repository.

\dothis{Select the \ct{package-cache} repository in the repository browser and click on \button{Save} to save the your own version of the Quinto game on your machine.}
