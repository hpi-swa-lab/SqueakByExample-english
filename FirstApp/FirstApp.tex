...
SBEScreenshotRecorder writeTo: './figures/AddCategory.png' frame: [:bounds | bounds * (0 asPoint corner: 0.4 @ 0.75)] building: [:helper |
	...
	helper click: window at: window topLeft + (50 @ 40) buttons: #(right).
...
\begin{ExecuteSmalltalkScript}
SBEScreenshotRecorder writeTo: './figures/Categorize.png' frame: [:bounds | bounds * (1 @ 0 rect: 1 @ 3 / 3.9)] building: [:helper |
	| class window |
	class := Object newSubclass.
	class compile: 'initialize'.
	ToolSet browseClass: class.
	window := helper foregroundWindow.
	window bounds: (0 @ 120 extent: 600 @ 350).
