...
%%  (HaloMorph new createHandleAt: 0 @ 0 color: Color blue iconName: 'Halo-Grab') openInWorld.
%%]}
%%{SBESqueakPicture writeTo: '../figures/moveHandle.png' frame: #morphs using: [:helper | | workspace |
%%  (HaloMorph new createHandleAt: 0 @ 0 color: Color blue iconName: 'Halo-Drag') openInWorld.
%%]}
...
%%  bill openInWorld.
%%  bill position: (joe position + (100@0)).
%%	start := StarMorph new color: Color yellow.
%%  joe addMorph: star.
