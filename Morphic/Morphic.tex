...
While we should avoid such situations in general, there is an accessor message, \ct{#currentEvent}, that allows us to retrieve the event currently being handled again from any method in any object.
...
Implementing this via the usual event-handling protocol would be complicated because we want to handle clicks that are not made to a morph controlled by ourselves.%
