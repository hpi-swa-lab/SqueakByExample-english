...
\end{method}
\noindent
Now execute \ct{Color orange asMorph} \mthind{Morph}{openInWorld} in a workspace.
...
For instance, if we start by evaluating \ct{DieMorph faces: 9}:
\begin{enumerate}
...
You will encounter this use of \ct{perform:} quite regularly.
\index{reflection}
