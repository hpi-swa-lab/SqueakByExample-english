...
For example, to display the request dialog in \figref{dialogName}, send a \ct{request:initialAnswer:} message:
\begin{code}{}
Project uiManager
	request: 'What''s your name?'
	initialAnswer: 'no name'
...
To display the request dialog in \figre{dialogChoosing}, send a \ct{chooseFrom:}:
\begin{code}{}
Project uiManager 
	chooseFrom: #('circle' 'oval' 'square' 'rectangle' 'triangle')
\end{code}
