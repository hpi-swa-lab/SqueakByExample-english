...
\begin{minipage}{0.587\textwidth}
	...
	\vfill
	\vspace{4ex}
	\caption{Dialog displayed by \ct{Project uiManager chooseFrom: \#('circle' 'oval' 'square' 'rectangle' 'triangle')}.}
\end{minipage}
\end{figure}
...
For example, to display a request dialog, send a \ct{request:initialAnswer:} message:
\begin{code}{}
Project uiManager
	request: 'What''s your name?'
	initialAnswer: 'no name'
