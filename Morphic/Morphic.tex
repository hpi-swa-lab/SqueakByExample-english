...
Morphic was developed by John Maloney and Randy Smith for the \ind{Self} language, starting around 1993.
Maloney later wrote a Morphic version for \sq, but the basic ideas of the Self version are still alive and well in \sq Morphic: \emph{directness} and \emph{liveness}.
...
\dothis{Bring up the world menu.
	Blue-click on the world menu to bring up its morphic halo, then blue-click again on a menu item to bring up its halo.
...
\end{ExecuteSmalltalkScript}
\begin{figure}[ht]
	\centerline{\includegraphics[width=0.4\textwidth]{joeStar}}
...
\begin{minipage}[t]{0.48\textwidth}
	\ifluluelse
		{\centerline{\includegraphics[width=0.3\textwidth]{overdrawBug}}}
...
\begin{minipage}[t]{0.48\textwidth}
	\ifluluelse
		{\centerline{\includegraphics[width=0.3\textwidth]{hairlineBug}}}
...
\end{ExecuteSmalltalkScript}
\begin{figure}[ht]
	\centerline{\includegraphics[width=0.3\textwidth]{die}}
...
\end{ExecuteSmalltalkScript}
\begin{figure}[ht]
	\centerline{\includegraphics[width=0.3\textwidth]{multiMorphs}}
