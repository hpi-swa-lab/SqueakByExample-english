...
When you are trying to do something with some object while writing a script or application, it is often a good idea to keep open a \ind{browser} (see \secref{browsing}) on its class and consult it from time to time as you are searching for a specific functionality.
