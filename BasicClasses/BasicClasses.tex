...
\begin{code}{@TEST}
Character value: 1   --> !\SqVersionSwitch{6.0}{Character home}{Character value: 1}!
...
Should you need more advanced support for regular expressions, you can also use the \ct{Regex} extension methods defined on \ct{String} from the \ct{Regex-Core} package.
