...
\begin{code}{NB: CANNOT TEST}
Object new exploreAndYourself --> !\emph{Object>>#exploreAndYourself has been deprecated. Use #explore because it does not return the tool window anymore. Only calls via ToolSet do so.}!
\end{code}
