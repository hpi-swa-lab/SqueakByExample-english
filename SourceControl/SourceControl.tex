...
\fi
%=================================================================
\chapter{Tools for storing and sharing source code}
...
Other change sets can be selected in the top-left pane; the \ind{yellow button} menu allows you to make a different change set current (\menu{make changes go to me (m)}), or to create a new change set.
