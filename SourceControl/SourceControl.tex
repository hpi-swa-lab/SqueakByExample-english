...
\begin{figure}[tbp]
	\begin{center}
		\includegraphics[width=.65\textwidth]{SBE-apb}
	\end{center}
...
This layout supports the change sorter's main feature: the ability to move or copy changes from one change set to another, as shown by the yellow button menu in \figref{dualChangeSorter}.
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.5\linewidth]{installNewChangeSet}
	\end{center}
