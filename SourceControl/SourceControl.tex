...
Let's say that you want to add a menu item to an inspector's context menu for opening its SQL version, so you have edited \ct{Inspector>>addObjectItemsTo:} and now would like to check it into your package repository.
...
\begin{figure}
	\includegraphics[width=\textwidth]{figures/browsePackageExtensions.png}
