...
If your dictionary only uses \clsindplural{Symbol} as keys, you can also use an \ct{IdentityDictionary} since every symbol is guaranteed to be globally unique.
