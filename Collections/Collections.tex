...
Literal arrays can contain numbers, \ct{nil}, \ct{true}, \ct{false}, characters, strings, symbols, and nested literal arrays.
...
Unless you copy the array, it will be a \emph{read-only object} and raise a \clsind{ModificationForbidden} error every time you try to alter it.
