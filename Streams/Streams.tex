...
Imagine you want to create an \ct{SBEHistory} class which will manage
...
\begin{code}{}
SBEHistory>>goBackward
  self canGoBackward ifFalse: [self error: 'Already on the first element'].
  stream skip: -2.
  ^ self next.

SBEHistory>>goForward
...
\begin{code}{}
SBEHistory>>canGoBackward
  ^ stream position > 1

SBEHistory>>canGoForward
