...
You can find it in the \menu{World docking bar~\go{} Help} menu at the top of the screen.
\end{itemize}
...
% In case you want to play in \sq with these code snippets, you can download a plain text file with all the example code from the book's website: \sbe.
