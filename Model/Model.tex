...
\begin{center}
	...
	\begin{tikzpicture}[
		...
		\node (browseInstance) at (-7.538,0.769) % (-7.538,1.769) % -20 (too left), 0,1-15 (too high)
		{\includegraphics[width=.462\textwidth]{Color-Buttons_browseInstance}}; % .6 (too wide)
		\node (browseClass) at (31.462,-10.385) % (31.462,-10.385) % (29.462,-10.385) % 29,31 (too left) % 55-56,60,40,20 (too right), -15,0 (too high)
...
\begin{tikzpicture}[      
	every node/.style={anchor=south west,inner sep=0pt},
	x=1mm, y=1mm%,
	%width=\textwidth % TODO: Support lulu
]
	\node (diagram) at (0,0)
	{\includegraphics[width=\textwidth]{fooNotFound}};
	\node (debugger) at (72,30)
	{\includegraphics[width=.32\textwidth]{fooNotFound_debugger}};  
\end{tikzpicture}
