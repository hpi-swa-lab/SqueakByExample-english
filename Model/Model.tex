...
\begin{center}
	\begin{tikzpicture}[      
		...
		\node (browseInstance) at (0,5) % 20 (too high)
		{\includegraphics[width=.4\textwidth]{Color-Buttons_browseInstance}}; % .6 (too wide)
		\node (browseClass) at (40,-5) % 10 (too high) 40 (x) -5 (too low)
		{\includegraphics[width=.4\textwidth]{Color-Buttons_browseClass}};
		\node (diagram) at (0,0) % TODO: move to end of list
