...
\ct{Smalltalk globals} answers an \clsind{Environment} instance which defines all of the global bindings and provides a \clsind{Dictionary}-like interface.
The keys of these bindings are the symbols that name the global objects in \st code.
So, for example,
\begin{code}{@TEST}
