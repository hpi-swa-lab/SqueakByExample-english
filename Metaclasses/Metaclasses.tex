...
TranslucentColor selectors sorted --> #(#addName: #alpha #alpha: #asHTMLColor #asNontranslucentColor #balancedPatternForDepth: #bitPatternForDepth: #convertToCurrentVersion:refStream: #hash #isOpaque #isTranslucent #isTranslucentColor #isTransparent #name #pixelValueForDepth: !\SqVersionSwitch{6.0}{\#pixelWord32 }{}!#pixelWordForDepth: !\SqVersionSwitch{6.0}{\#printOn: }{}!#privateAlpha #scaledPixelValue32 !\SqVersionSwitch{6.0}{\#setAlpha: }{}!#setRgb:alpha: #storeArrayValuesOn: #storeOn:)
\end{code}
