...
\begin{ExecuteSmalltalkScript}
SBEScreenshotRecorder writeTo: './figures/Doit.png' frame: [:morphsRect | morphsRect withBottom: morphsRect bottom - 150] building: [:helper |
  | workspace |
...
SBEScreenshotRecorder writeInto: './figures' recordSeries: [:picture :helper |
	...
	helper
		...
		then: [
			...
			picture writeTo: 'FindIt.png' building: [].
