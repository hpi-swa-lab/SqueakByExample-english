...
%%{SBESqueakPicture writeTo: './figures/PreferenceBrowser.png' frame: #morphs using: [:helper | | browser |
%%  browser := PreferenceBrowser open.
%%  browser searchPreferencesFor: 'swap'.
%%  helper click: (helper preferenceButtonMorphLabeled: 'swapMouseButtons' in: helper world).
%%]}
