...
%%{SBESqueakPicture writeTo: './figures/morphicRotate.png' fromForm: [:helper |
%%  helper haloHandleFormFor: 'Halo-Rot'
%%]}
...
%%  helper click: helper foregroundWindow firstSubmorph firstSubmorph.
%%  helper click: helper foregroundWindow firstSubmorph firstSubmorph.
%%]}
...
%%	Browser fullOnClass: StringTest category: #'tests - converting'.
%%	textField := helper foregroundWindow firstSubmorph firstSubmorph.
...
%%	thisContext insertEnsure: [StringTest removeSelector: #testShout].
