...
%%{SBESqueakPicture writeTo: './figures/morphicHaloOnWorkspace.png' frame: [:rect | rect expandBy: 60] using: [:helper | | workspace |
%%  workspace := ToolBuilder open: Workspace new.
%   workspace position: 100 asPoint.
%%  helper type: 'Time now ' into: workspace.
...
%%{SBESqueakPicture writeTo: './figures/testRunnerOnStringTest.png' frame: #morphs using: [:helper | | testRunner categoryIndex |
%%  [
